...
const skillDetailsData = [
    ...
    },
    {
        ...
        tools: ["Διαχείριση Αποθέματος", "Συγχρονισμός Τιμών", "Κωδικοποίηση Προϊόντων", "Παρακολούθηση Αποθέματος"]
    },
	{
    ...
    },
    {
        ...
        tools: ["Διαχείριση CMS", "Προσαρμογή Templates", "Ανάπτυξη Modules", "Εφαρμογή Στρατηγικής SEO"]
    },
	//  E-commerce skils
   {
    ...
    },
   {
    ...
    },
	{
        ...
        tools: ["On-page SEO", "Meta Tags", "Keyword Research", "Βελτιστοποίηση Περιεχομένου"]
    },
	{
    ...
    },
    {
        ...
        description: "3-person team στο Product Content, daily Έλεγχος Ποιότητας",
        achievements: [
        ...
        tools: ["Συντονισμός Ομάδας", "Διαχείριση Εργασιών", "Έλεγχος Ποιότητας", "Εκπαίδευση & Ανάπτυξη"]
    },
    {
    ...
    },
    {
        ...
        achievements: [
            "Professional Συγγραφή Περιεχομένου για pharmaceutical products",
    ...
    },
    {
        ...
        description: "Αριθμός Μητρώου: KB/16028",
        achievements: [
